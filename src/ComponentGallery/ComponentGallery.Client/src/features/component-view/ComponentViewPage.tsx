...
import { Box, Heading, Text, SimpleGrid, Stack, Badge, Grid, GridItem, Image, Button } from '@chakra-ui/react';
...
export function ComponentViewPage() {
    ...
    const { data: component, isLoading: isComponentLoading } = useQuery({
        ...
        queryFn: () => dataService.getComponentById(componentId ? parseInt(componentId, 10) : 0),
    });
